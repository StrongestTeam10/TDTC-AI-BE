...
public record ScenarioRequestDto(
        ...
        // 2026-08-14: agentCount는 '추가 유입 인원'. 0 허용 - 0이면 관측 인원만으로 시뮬.
        ...
        // 2026-08-12 추가: 관측 프레임 선택 기준 시각. FE가 개입 전(predict)과 동일한
        // 값을 보내면 BE가 같은 프레임을 골라 개입 전/후 관측 초기배치가 일치한다.
        Instant capturedAt,

        // 2026-08-12 추가: CCTV 관측 초기배치. BE가 채운다(FE는 안 보냄). null이면 빈 목록.

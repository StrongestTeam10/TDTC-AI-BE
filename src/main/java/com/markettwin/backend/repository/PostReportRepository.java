...
public interface PostReportRepository extends JpaRepository<PostReport, Long> {
    ...
    @org.springframework.data.jpa.repository.Query("DELETE FROM PostReport p WHERE p.createdAt < :threshold")
    void deleteByCreatedAtBefore(@org.springframework.data.repository.query.Param("threshold") java.time.Instant threshold);
